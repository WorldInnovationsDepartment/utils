...
def main():
    ...
    reassemble_video(
        upscaled_dir, output_path, info['fps'], input_path,
        info['has_audio'], args.seconds,
    )
    ...
    if args.cleanup:
        ...
        print(f'\n  Temp frames kept at: {work_dir}')
        print('  Re-run with --cleanup to remove, or delete manually.')
